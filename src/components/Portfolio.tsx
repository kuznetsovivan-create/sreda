...
const PORTFOLIO_ITEMS: PortfolioItem[] = [
  {
    ...
    beforeImage: getAssetPath('scandinavia-before.avif'),
    afterImage: getAssetPath('scandinavia-after.avif'),
    duration: '65 дней',
    cost: 1680000,
    area: 72,
  ...
  },
  {
    ...
    category: 'kitchen',
    beforeImage: getAssetPath('patriarshie-before.avif'),
    afterImage: getAssetPath('patriarshie-after.avif'),
    duration: '28 дней',
    cost: 720000,
    area: 28,
  ...
  },
  {
    ...
    category: 'bathroom',
    beforeImage: getAssetPath('residence-before.avif'),
    afterImage: getAssetPath('residence-after.avif'),
    duration: '16 дней',
    cost: 450000,
    area: 8.5,
  ...
  },
  {
    ...
    afterImage: getAssetPath('loft-after.avif'),
    duration: '42 дня',
    cost: 980000,
    area: 45,
  ...
  },
  {
    ...
    afterImage: getAssetPath('metropolia-after.avif'),
    duration: '25 дней',
    cost: 590000,
    area: 31,
  ...
  },
  {
    ...
    afterImage: getAssetPath('classic-after.avif'),
    duration: '45 дней',
    cost: 1150000,
    area: 36,
